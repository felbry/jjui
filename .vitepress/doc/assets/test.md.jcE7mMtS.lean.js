...
], -1), f = /* @__PURE__ */ r("", 2), A = /* @__PURE__ */ r("", 2), D = ["manifest"], x = JSON.parse('{"title":"Test 测试","description":"","frontmatter":{},"headers":[],"relativePath":"test.md","filePath":"packages/test/test.md"}'), T = { name: "test.md" }, B = /* @__PURE__ */ Object.assign(T, {
  setup(l) {
    return (h, p) => {
