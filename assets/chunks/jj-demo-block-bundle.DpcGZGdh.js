...
* SPDX-License-Identifier: BSD-3-Clause
*/const{I:Hr}=_r,de=(e,t)=>(e==null?void 0:e._$litType$)!==void 0,Ur=e=>{var t;return((t=e==null?void 0:e._$litType$)==null?void 0:t.h)!=null},he=()=>document.createComment(""),pe=(e,t,r)=>{var n;const i=e._$AA.parentNode,s=e._$AB;if(r===void 0){const o=i.insertBefore(he(),s),a=i.insertBefore(he(),s);r=new Hr(o,a,e,e.options)}else{const o=r._$AB.nextSibling,a=r._$AM,p=a!==e;if(p){let g;(n=r._$AQ)==null||n.call(r,e),r._$AM=e,r._$AP!==void 0&&(g=e._$AU)!==a._$AU&&r._$AP(g)}if(o!==s||p){let g=r._$AA;for(;g!==o;){const k=g.nextSibling;i.insertBefore(g,s),g=k}}}return r},Nr={},fe=(e,t=Nr)=>e._$AH=t,ve=e=>e._$AH,Dr=e=>{e._$AR()};/**
* @license
* Copyright 2017 Google LLC
* SPDX-License-Identifier: BSD-3-Clause
*/const be=e=>Ur(e)?e._$litType$.h:e.strings,Ir=He(class extends Ue{constructor(e){super(e),this.et=new WeakMap}render(e){return[e]}update(e,[t]){const r=de(this.it)?be(this.it):null,n=de(t)?be(t):null;if(r!==null&&(n===null||r!==n)){const i=ve(e).pop();let s=this.et.get(r);if(s===void 0){const o=document.createDocumentFragment();s=Pe(z,o),s.setConnected(!1),this.et.set(r,s)}fe(s,[i]),pe(s,void 0,i)}if(n!==null){if(r===null||r!==n){const i=this.et.get(n);if(i!==void 0){const s=ve(i).pop();Dr(e),pe(e,void 0,s),fe(e,[s])}}this.it=t}else this.it=void 0;return this.render(t)}});/**
* @license
* Copyright 2017 Google LLC
* SPDX-License-Identifier: BSD-3-Clause
...
* Copyright 2017 Google LLC
* SPDX-License-Identifier: BSD-3-Clause
*/class Zt extends Ue{constructor(t){if(super(t),this.it=z,t.type!==Lr.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===z||t==null)return this._t=void 0,this.it=t;if(t===ft)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;const r=[t];return r.raw=r,this._t={_$litType$:this.constructor.resultType,strings:r,values:[]}}}Zt.directiveName="unsafeHTML",Zt.resultType=1;const ut=He(Zt);/**
* @license
* Copyright 2021 Google LLC
* SPDX-License-Identifier: BSD-3-Clause
...
* SPDX-License-Identifier: BSD-3-Clause
*/function Br({context:e,subscribe:t}){return(r,n)=>{typeof n=="object"?n.addInitializer(function(){new ge(this,{context:e,callback:i=>{r.set.call(this,i)},subscribe:t})}):r.constructor.addInitializer(i=>{new ge(i,{context:e,callback:s=>{i[n]=s},subscribe:t})})}}let me;function Rr(e,t,r,n,i,s){var o,a,p,g,k,w,A,M=Symbol.metadata||Symbol.for("Symbol.metadata"),D=Object.defineProperty,I=Object.create,V=[I(null),I(null)],Q=t.length;function O(c,m,v){return function(l,u){m&&(u=l,l=e);for(var y=0;y<c.length;y++)u=c[y].apply(l,v?[u]:[]);return v?u:l}}function _(c,m,v,l){if(typeof c!="function"&&(l||c!==void 0))throw new TypeError(m+" must "+(v||"be")+" a function"+(l?"":" or undefined"));return c}function J(c,m,v,l,u,y,C,b,x,$,G){function B(h){if(!G(h))throw new TypeError("Attempted to access private element on non-instance")}var R=[].concat(m[0]),K=m[3],Z=!C,j=u===1,F=u===3,tt=u===4,L=u===2;function H(h,E,nt){return function(N,it){return E&&(it=N,N=c),nt&&nt(N),d[h].call(N,it)}}if(!Z){var d={},W=[],S=F?"get":tt||j?"set":"value";if(x?($||j?d={get:ye(function(){return K(this)},l,"get"),set:function(h){m[4](this,h)}}:d[S]=K,$||ye(d[S],l,L?"":S)):$||(d=Object.getOwnPropertyDescriptor(c,l)),!$&&!x){if((a=V[+b][l])&&(a^u)!=7)throw Error("Decorating two elements with the same name ("+d[S].name+") is not supported yet");V[+b][l]=u<3?1:u}}for(var f=c,U=R.length-1;U>=0;U-=v?2:1){var et=_(R[U],"A decorator","be",!0),rt=v?R[U-1]:void 0,q={},P={kind:["field","accessor","method","getter","setter","class"][u],name:l,metadata:o,addInitializer:(function(h,E){if(h.v)throw new TypeError("attempted to call addInitializer after decoration was finished");_(E,"An initializer","be",!0),y.push(E)}).bind(null,q)};if(Z)a=et.call(rt,f,P),q.v=1,_(a,"class decorators","return")&&(f=a);else if(P.static=b,P.private=x,a=P.access={has:x?G.bind():function(h){return l in h}},tt||(a.get=x?L?function(h){return B(h),d.value}:H("get",0,B):function(h){return h[l]}),L||F||(a.set=x?H("set",0,B):function(h,E){h[l]=E}),f=et.call(rt,j?{get:d.get,set:d.set}:d[S],P),q.v=1,j){if(typeof f=="object"&&f)(a=_(f.get,"accessor.get"))&&(d.get=a),(a=_(f.set,"accessor.set"))&&(d.set=a),(a=_(f.init,"accessor.init"))&&W.unshift(a);else if(f!==void 0)throw new TypeError("accessor decorators must return an object with get, set, or init properties or undefined")}else _(f,($?"field":"method")+" decorators","return")&&($?W.unshift(f):d[S]=f)}return u<2&&C.push(O(W,b,1),O(y,b,0)),$||Z||(x?j?C.splice(-1,0,H("get",b),H("set",b)):C.push(L?d[S]:_.call.bind(d[S])):D(c,l,d)),f}function X(c){return D(c,M,{configurable:!0,enumerable:!0,value:o})}return s!==void 0&&(o=s[M]),o=I(o??null),k=[],w=function(c){c&&k.push(O(c))},A=function(c,m){for(var v=0;v<r.length;v++){var l=r[v],u=l[1],y=7&u;if((8&u)==c&&!y==m){var C=l[2],b=!!l[3],x=16&u;J(c?e:e.prototype,l,x,b?"#"+C:Zr(C),y,y<2?[]:c?g=g||[]:p=p||[],k,!!c,b,m,c&&b?function($){return qr($)===e}:i)}}},A(8,0),A(0,0),A(8,1),A(0,1),w(p),w(g),a=k,Q||X(e),{e:a,get c(){var c=[];return Q&&[X(e=J(e,[t],n,e.name,5,c)),O(c,1)]}}}function Zr(e){var t=Wr(e,"string");return typeof t=="symbol"?t:t+""}function Wr(e,t){if(typeof e!="object"||!e)return e;var r=e[Symbol.toPrimitive];if(r!==void 0){var n=r.call(e,t);if(typeof n!="object")return n;throw new TypeError("@@toPrimitive must return a primitive value.")}return(t==="string"?String:Number)(e)}function ye(e,t,r){typeof t=="symbol"&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch{}return e}function qr(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(e!==null?typeof e:"null"));return e}let Yr;var Rt;Rt=class extends Y{render(){return T`<div
...
.leading-5\\.5{line-height:1.375rem;};
      `]}},[Yr,me]=Rr(Rt,[Qt("jj-demo-block-desktop-view")],[],0,void 0,Y).c,me();let we;function Vr(e,t,r,n,i,s){var o,a,p,g,k,w,A,M=Symbol.metadata||Symbol.for("Symbol.metadata"),D=Object.defineProperty,I=Object.create,V=[I(null),I(null)],Q=t.length;function O(c,m,v){return function(l,u){m&&(u=l,l=e);for(var y=0;y<c.length;y++)u=c[y].apply(l,v?[u]:[]);return v?u:l}}function _(c,m,v,l){if(typeof c!="function"&&(l||c!==void 0))throw new TypeError(m+" must "+(v||"be")+" a function"+(l?"":" or undefined"));return c}function J(c,m,v,l,u,y,C,b,x,$,G){function B(h){if(!G(h))throw new TypeError("Attempted to access private element on non-instance")}var R=[].concat(m[0]),K=m[3],Z=!C,j=u===1,F=u===3,tt=u===4,L=u===2;function H(h,E,nt){return function(N,it){return E&&(it=N,N=c),nt&&nt(N),d[h].call(N,it)}}if(!Z){var d={},W=[],S=F?"get":tt||j?"set":"value";if(x?($||j?d={get:xe(function(){return K(this)},l,"get"),set:function(h){m[4](this,h)}}:d[S]=K,$||xe(d[S],l,L?"":S)):$||(d=Object.getOwnPropertyDescriptor(c,l)),!$&&!x){if((a=V[+b][l])&&(a^u)!=7)throw Error("Decorating two elements with the same name ("+d[S].name+") is not supported yet");V[+b][l]=u<3?1:u}}for(var f=c,U=R.length-1;U>=0;U-=v?2:1){var et=_(R[U],"A decorator","be",!0),rt=v?R[U-1]:void 0,q={},P={kind:["field","accessor","method","getter","setter","class"][u],name:l,metadata:o,addInitializer:(function(h,E){if(h.v)throw new TypeError("attempted to call addInitializer after decoration was finished");_(E,"An initializer","be",!0),y.push(E)}).bind(null,q)};if(Z)a=et.call(rt,f,P),q.v=1,_(a,"class decorators","return")&&(f=a);else if(P.static=b,P.private=x,a=P.access={has:x?G.bind():function(h){return l in h}},tt||(a.get=x?L?function(h){return B(h),d.value}:H("get",0,B):function(h){return h[l]}),L||F||(a.set=x?H("set",0,B):function(h,E){h[l]=E}),f=et.call(rt,j?{get:d.get,set:d.set}:d[S],P),q.v=1,j){if(typeof f=="object"&&f)(a=_(f.get,"accessor.get"))&&(d.get=a),(a=_(f.set,"accessor.set"))&&(d.set=a),(a=_(f.init,"accessor.init"))&&W.unshift(a);else if(f!==void 0)throw new TypeError("accessor decorators must return an object with get, set, or init properties or undefined")}else _(f,($?"field":"method")+" decorators","return")&&($?W.unshift(f):d[S]=f)}return u<2&&C.push(O(W,b,1),O(y,b,0)),$||Z||(x?j?C.splice(-1,0,H("get",b),H("set",b)):C.push(L?d[S]:_.call.bind(d[S])):D(c,l,d)),f}function X(c){return D(c,M,{configurable:!0,enumerable:!0,value:o})}return s!==void 0&&(o=s[M]),o=I(o??null),k=[],w=function(c){c&&k.push(O(c))},A=function(c,m){for(var v=0;v<r.length;v++){var l=r[v],u=l[1],y=7&u;if((8&u)==c&&!y==m){var C=l[2],b=!!l[3],x=16&u;J(c?e:e.prototype,l,x,b?"#"+C:Qr(C),y,y<2?[]:c?g=g||[]:p=p||[],k,!!c,b,m,c&&b?function($){return Xr($)===e}:i)}}},A(8,0),A(0,0),A(8,1),A(0,1),w(p),w(g),a=k,Q||X(e),{e:a,get c(){var c=[];return Q&&[X(e=J(e,[t],n,e.name,5,c)),O(c,1)]}}}function Qr(e){var t=Jr(e,"string");return typeof t=="symbol"?t:t+""}function Jr(e,t){if(typeof e!="object"||!e)return e;var r=e[Symbol.toPrimitive];if(r!==void 0){var n=r.call(e,t);if(typeof n!="object")return n;throw new TypeError("@@toPrimitive must return a primitive value.")}return(t==="string"?String:Number)(e)}function xe(e,t,r){typeof t=="symbol"&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch{}return e}function Xr(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(e!==null?typeof e:"null"));return e}let Gr;const Kr=class extends Y{render(){return T`<div
...
.font-500{font-weight:500;};
      `]}};[Gr,we]=Vr(Kr,[Qt("jj-demo-block-mobile-view")],[],0,void 0,Y).c,we();let $e,Ne,De,Ie,Be,Re,Ze,We,qe,Ye,Ve,Qe,Je,Xe,Ge,Ke,Fe;function Fr(e,t,r,n,i,s){var o,a,p,g,k,w,A,M=Symbol.metadata||Symbol.for("Symbol.metadata"),D=Object.defineProperty,I=Object.create,V=[I(null),I(null)],Q=t.length;function O(c,m,v){return function(l,u){m&&(u=l,l=e);for(var y=0;y<c.length;y++)u=c[y].apply(l,v?[u]:[]);return v?u:l}}function _(c,m,v,l){if(typeof c!="function"&&(l||c!==void 0))throw new TypeError(m+" must "+(v||"be")+" a function"+(l?"":" or undefined"));return c}function J(c,m,v,l,u,y,C,b,x,$,G){function B(h){if(!G(h))throw new TypeError("Attempted to access private element on non-instance")}var R=[].concat(m[0]),K=m[3],Z=!C,j=u===1,F=u===3,tt=u===4,L=u===2;function H(h,E,nt){return function(N,it){return E&&(it=N,N=c),nt&&nt(N),d[h].call(N,it)}}if(!Z){var d={},W=[],S=F?"get":tt||j?"set":"value";if(x?($||j?d={get:ke(function(){return K(this)},l,"get"),set:function(h){m[4](this,h)}}:d[S]=K,$||ke(d[S],l,L?"":S)):$||(d=Object.getOwnPropertyDescriptor(c,l)),!$&&!x){if((a=V[+b][l])&&(a^u)!=7)throw Error("Decorating two elements with the same name ("+d[S].name+") is not supported yet");V[+b][l]=u<3?1:u}}for(var f=c,U=R.length-1;U>=0;U-=v?2:1){var et=_(R[U],"A decorator","be",!0),rt=v?R[U-1]:void 0,q={},P={kind:["field","accessor","method","getter","setter","class"][u],name:l,metadata:o,addInitializer:(function(h,E){if(h.v)throw new TypeError("attempted to call addInitializer after decoration was finished");_(E,"An initializer","be",!0),y.push(E)}).bind(null,q)};if(Z)a=et.call(rt,f,P),q.v=1,_(a,"class decorators","return")&&(f=a);else if(P.static=b,P.private=x,a=P.access={has:x?G.bind():function(h){return l in h}},tt||(a.get=x?L?function(h){return B(h),d.value}:H("get",0,B):function(h){return h[l]}),L||F||(a.set=x?H("set",0,B):function(h,E){h[l]=E}),f=et.call(rt,j?{get:d.get,set:d.set}:d[S],P),q.v=1,j){if(typeof f=="object"&&f)(a=_(f.get,"accessor.get"))&&(d.get=a),(a=_(f.set,"accessor.set"))&&(d.set=a),(a=_(f.init,"accessor.init"))&&W.unshift(a);else if(f!==void 0)throw new TypeError("accessor decorators must return an object with get, set, or init properties or undefined")}else _(f,($?"field":"method")+" decorators","return")&&($?W.unshift(f):d[S]=f)}return u<2&&C.push(O(W,b,1),O(y,b,0)),$||Z||(x?j?C.splice(-1,0,H("get",b),H("set",b)):C.push(L?d[S]:_.call.bind(d[S])):D(c,l,d)),f}function X(c){return D(c,M,{configurable:!0,enumerable:!0,value:o})}return s!==void 0&&(o=s[M]),o=I(o??null),k=[],w=function(c){c&&k.push(O(c))},A=function(c,m){for(var v=0;v<r.length;v++){var l=r[v],u=l[1],y=7&u;if((8&u)==c&&!y==m){var C=l[2],b=!!l[3],x=16&u;J(c?e:e.prototype,l,x,b?"#"+C:tn(C),y,y<2?[]:c?g=g||[]:p=p||[],k,!!c,b,m,c&&b?function($){return rn($)===e}:i)}}},A(8,0),A(0,0),A(8,1),A(0,1),w(p),w(g),a=k,Q||X(e),{e:a,get c(){var c=[];return Q&&[X(e=J(e,[t],n,e.name,5,c)),O(c,1)]}}}function tn(e){var t=en(e,"string");return typeof t=="symbol"?t:t+""}function en(e,t){if(typeof e!="object"||!e)return e;var r=e[Symbol.toPrimitive];if(r!==void 0){var n=r.call(e,t);if(typeof n!="object")return n;throw new TypeError("@@toPrimitive must return a primitive value.")}return(t==="string"?String:Number)(e)}function ke(e,t,r){typeof t=="symbol"&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch{}return e}function rn(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(e!==null?typeof e:"null"));return e}let nn;var Et,zt,jt,Pt,Mt,Tt,Ot,Lt;const on=class extends Y{constructor(...t){super(...t),at(this,Et,Ne(this,"")),at(this,zt,(De(this),Ie(this,"100%"))),at(this,jt,(Be(this),Re(this,"hello, world"))),at(this,Pt,(Ze(this),We(this,!1))),at(this,Mt,(qe(this),Ye(this,{}))),at(this,Tt,(Ve(this),Qe(this,[]))),at(this,Ot,(Je(this),Xe(this,!1))),at(this,Lt,(Ge(this),Ke(this,!1))),Fe(this)}get iframeUrl(){return st(this,Et)}set iframeUrl(t){ct(this,Et,t)}get iframeHeight(){return st(this,zt)}set iframeHeight(t){ct(this,zt,t)}get rawSource(){return st(this,jt)}set rawSource(t){ct(this,jt,t)}get isShowSourcePermanently(){return st(this,Pt)}set isShowSourcePermanently(t){ct(this,Pt,t)}get globalSetting(){return st(this,Mt)}set globalSetting(t){ct(this,Mt,t)}get _devices(){return st(this,Tt)}set _devices(t){ct(this,Tt,t)}_onCheckDevice(t){this._devices.forEach(r=>{r.checked=r.id===t}),this.requestUpdate()}willUpdate(t){t.has("globalSetting")&&(this._devices=JSON.parse(JSON.stringify(this.globalSetting.devices||[])))}get _isCopied(){return st(this,Ot)}set _isCopied(t){ct(this,Ot,t)}async _onCopyCode(){if(!this._isCopied)try{await navigator.clipboard.writeText(decodeURIComponent(this.rawSource)),this._isCopied=!0,setTimeout(()=>{this._isCopied=!1},2e3)}catch(t){console.error("Failed to copy: ",t)}}get _isShowSource(){return st(this,Lt)}set _isShowSource(t){ct(this,Lt,t)}_onToggleSourceVisible(){this._isShowSource=!this._isShowSource}render(){return T`<div
...
* Copyright 2017 Google LLC
* SPDX-License-Identifier: BSD-3-Clause
*/function dn({context:e}){return(t,r)=>{const n=new WeakMap;if(typeof r=="object")return{get(){return t.get.call(this)},set(i){return n.get(this).setValue(i),t.set.call(this,i)},init(i){return n.set(this,new _e(this,{context:e,initialValue:i})),i}};{t.constructor.addInitializer(o=>{n.set(o,new _e(o,{context:e}))});const i=Object.getOwnPropertyDescriptor(t,r);let s;if(i===void 0){const o=new WeakMap;s={get(){return o.get(this)},set(a){n.get(this).setValue(a),o.set(this,a)},configurable:!0,enumerable:!0}}else{const o=i.set;s={...i,set(a){n.get(this).setValue(a),o==null||o.call(this,a)}}}return void Object.defineProperty(t,r,s)}}}let rr,nr;function hn(e,t,r,n,i,s){var o,a,p,g,k,w,A,M=Symbol.metadata||Symbol.for("Symbol.metadata"),D=Object.defineProperty,I=Object.create,V=[I(null),I(null)],Q=t.length;function O(c,m,v){return function(l,u){m&&(u=l,l=e);for(var y=0;y<c.length;y++)u=c[y].apply(l,v?[u]:[]);return v?u:l}}function _(c,m,v,l){if(typeof c!="function"&&(l||c!==void 0))throw new TypeError(m+" must "+(v||"be")+" a function"+(l?"":" or undefined"));return c}function J(c,m,v,l,u,y,C,b,x,$,G){function B(h){if(!G(h))throw new TypeError("Attempted to access private element on non-instance")}var R=[].concat(m[0]),K=m[3],Z=!C,j=u===1,F=u===3,tt=u===4,L=u===2;function H(h,E,nt){return function(N,it){return E&&(it=N,N=c),nt&&nt(N),d[h].call(N,it)}}if(!Z){var d={},W=[],S=F?"get":tt||j?"set":"value";if(x?($||j?d={get:Se(function(){return K(this)},l,"get"),set:function(h){m[4](this,h)}}:d[S]=K,$||Se(d[S],l,L?"":S)):$||(d=Object.getOwnPropertyDescriptor(c,l)),!$&&!x){if((a=V[+b][l])&&(a^u)!=7)throw Error("Decorating two elements with the same name ("+d[S].name+") is not supported yet");V[+b][l]=u<3?1:u}}for(var f=c,U=R.length-1;U>=0;U-=v?2:1){var et=_(R[U],"A decorator","be",!0),rt=v?R[U-1]:void 0,q={},P={kind:["field","accessor","method","getter","setter","class"][u],name:l,metadata:o,addInitializer:(function(h,E){if(h.v)throw new TypeError("attempted to call addInitializer after decoration was finished");_(E,"An initializer","be",!0),y.push(E)}).bind(null,q)};if(Z)a=et.call(rt,f,P),q.v=1,_(a,"class decorators","return")&&(f=a);else if(P.static=b,P.private=x,a=P.access={has:x?G.bind():function(h){return l in h}},tt||(a.get=x?L?function(h){return B(h),d.value}:H("get",0,B):function(h){return h[l]}),L||F||(a.set=x?H("set",0,B):function(h,E){h[l]=E}),f=et.call(rt,j?{get:d.get,set:d.set}:d[S],P),q.v=1,j){if(typeof f=="object"&&f)(a=_(f.get,"accessor.get"))&&(d.get=a),(a=_(f.set,"accessor.set"))&&(d.set=a),(a=_(f.init,"accessor.init"))&&W.unshift(a);else if(f!==void 0)throw new TypeError("accessor decorators must return an object with get, set, or init properties or undefined")}else _(f,($?"field":"method")+" decorators","return")&&($?W.unshift(f):d[S]=f)}return u<2&&C.push(O(W,b,1),O(y,b,0)),$||Z||(x?j?C.splice(-1,0,H("get",b),H("set",b)):C.push(L?d[S]:_.call.bind(d[S])):D(c,l,d)),f}function X(c){return D(c,M,{configurable:!0,enumerable:!0,value:o})}return s!==void 0&&(o=s[M]),o=I(o??null),k=[],w=function(c){c&&k.push(O(c))},A=function(c,m){for(var v=0;v<r.length;v++){var l=r[v],u=l[1],y=7&u;if((8&u)==c&&!y==m){var C=l[2],b=!!l[3],x=16&u;J(c?e:e.prototype,l,x,b?"#"+C:pn(C),y,y<2?[]:c?g=g||[]:p=p||[],k,!!c,b,m,c&&b?function($){return vn($)===e}:i)}}},A(8,0),A(0,0),A(8,1),A(0,1),w(p),w(g),a=k,Q||X(e),{e:a,get c(){var c=[];return Q&&[X(e=J(e,[t],n,e.name,5,c)),O(c,1)]}}}function pn(e){var t=fn(e,"string");return typeof t=="symbol"?t:t+""}function fn(e,t){if(typeof e!="object"||!e)return e;var r=e[Symbol.toPrimitive];if(r!==void 0){var n=r.call(e,t);if(typeof n!="object")return n;throw new TypeError("@@toPrimitive must return a primitive value.")}return(t==="string"?String:Number)(e)}function Se(e,t,r){typeof t=="symbol"&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch{}return e}function vn(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(e!==null?typeof e:"null"));return e}const ir="jj-demo-block-setting";class bn{constructor(){const t=localStorage.getItem(ir);t?(Object.assign(this,JSON.parse(t)),this.devices.forEach(r=>{r.type==="mobile"&&(r.icon=le),r.type==="desktop"&&(r.icon=ue)})):(this.isShowHeader=!0,this.devices=[{id:1,width:"375px",type:"mobile",name:"Mobile",enable:!0,checked:!1,icon:le},{id:2,width:"100%",type:"desktop",name:"Desktop",enable:!0,checked:!0,icon:ue}])}}var Ht;const or=class extends Y{constructor(...t){super(...t),an(this,Ht,rr(this,new bn)),nr(this)}get globalSetting(){return sn(this,Ht)}set globalSetting(t){cn(this,Ht,t)}_saveGlobalSetting(){const t=JSON.parse(JSON.stringify(this.globalSetting));t.devices.forEach(r=>delete r.icon),localStorage.setItem(ir,JSON.stringify(t)),this.globalSetting={...this.globalSetting}}_toggleIsShowHeader(t){this.globalSetting.isShowHeader=t.target.checked,this._saveGlobalSetting()}_toggleDeviceEnable(t,r){const n=this.globalSetting.devices.find(i=>i.id===t);if(n){if(n.enable=r.target.checked,!n.enable&&n.checked){n.checked=!1;const i=this.globalSetting.devices.find(s=>s.enable);i&&(i.checked=!0)}this.globalSetting.devices.some(i=>i.enable)||(this.globalSetting.isShowHeader=!1),this._saveGlobalSetting()}}_checkDevice(t){this.globalSetting.devices.forEach(r=>{r.checked=r.id===t}),this._saveGlobalSetting()}render(){const t=this.globalSetting.devices.filter(r=>r.enable);return T`<div>
      <slot></slot>
...
.ease-in-out{transition-timing-function:cubic-bezier(0.4, 0, 0.2, 1);};
      `]}};Ht=new WeakMap,[rr,nr]=hn(or,[],[[[dn({context:Te}),bt({attribute:!1})],1,"globalSetting"]],0,void 0,Y).e;let gn=or;window.customElements.define("jj-demo-block-setting",gn);
